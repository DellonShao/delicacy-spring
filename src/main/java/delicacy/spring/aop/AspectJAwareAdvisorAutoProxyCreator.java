...
/**
*@Author: shaodilong
*@Description: 实现了BeanFactoryAware接口：这个接口提供了对 BeanFactory 的感知，这样，尽管它是容器中的一个 Bean，却
 * 可以获取容器 的引用，进而获取容器中所有的切点对象，决定对哪些对象的哪些方法进行代理。解决了为哪些对象
 * 提供 AOP 的植入 的问题。
*@Date: Created in 2019/5/20 17:43
*@Modify By:
*/
public class AspectJAwareAdvisorAutoProxyCreator implements BeanPostProcessor, BeanFactoryAware {
    ...
    //bean实例化后是需要进行初始化操作，会经过这个方法满足条件则生成相关的代理类并返回
    @Override
